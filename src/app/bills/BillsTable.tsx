...
// refreshedAt is computed on the server (see bills/page.tsx). Because the server
// render and the client hydration use the SAME string, there is no
// "Text content did not match" warning that calling new Date() here would cause.
  ...
  return (
    <>
      ...
      <table className="mt-2 w-full">
        ...
        <tbody>
          {bills.map((b) => {
            // null when paid; daysPastDue() already clamps not-yet-due to 0.
